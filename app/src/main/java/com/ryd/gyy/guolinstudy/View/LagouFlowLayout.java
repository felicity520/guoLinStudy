...
/**
 * Created by Danny 姜.拉钩教育提供的流式布局，类似查看历史记录这样的布局
 */
public class LagouFlowLayout extends ViewGroup {
    ...
    public LagouFlowLayout(Context context) {
        super(context);
    }

    public LagouFlowLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LagouFlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
